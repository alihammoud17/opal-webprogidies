...
const Search = ({ workspaceId }: Props) => {
    ...
    // Wire up sending invitations to users
    // Wire up invite button in UI
    ...
    return (
        <div className='flex flex-col gap-y-5'>
            <Input placeholder='Search for your user...' value={query} onChange={onSearchQuery}
                className='bg-transparent border-[#333333] border-2 text-neutral-400 outline-none' />
            {
                isFetching ? (
